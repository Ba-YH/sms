...
import edu.scau.sms.entity.Teacher;
import edu.scau.sms.mapper.UserMapper;
...
public class UserController {
    ...
    public String userUpdateStudent(@PathVariable("id") String id,Model model){
    ...
    public String userUpdateTeacher(@PathVariable("id") String id,Model model){
        User u = userMapper.selectById(id);
        model.addAttribute("user",u);
    ...
    public String toUserUpdatePassword(@PathVariable("id") String id,Model model){
        User u = userMapper.selectById(id);
        model.addAttribute("user",u);
