...
import edu.scau.sms.entity.*;
import edu.scau.sms.entity.Class;
import edu.scau.sms.mapper.CurriculumMapper;
...
public class CurriculumController {
    ...
    public String toCurriculumList(Model model){
        ...
        for (Curriculum curriculum : curriculumList) {
            ...
            curriculum.setMajor(classController.getClassById(curriculum.getClassNO()).getMajor());
            curriculum.setClasss(classController.getClassById(curriculum.getClassNO()).getClasss());
        }
